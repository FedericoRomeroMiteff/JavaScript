...
h1.style.fontFamily = "'Pacifico', sans-serif";
...
h2.style.fontFamily = "'Pacifico', sans-serif";
...
p1.style.fontFamily = "'Pacifico', sans-serif";
...
labelDolar.style.fontFamily = "'Pacifico', sans-serif";
...
labelEuro.style.fontFamily = "'Pacifico', sans-serif";
...
p2.style.fontFamily = "'Pacifico', sans-serif";
...
inputValorEnPesos.style.fontFamily = "'Pacifico', sans-serif";
...
function conversiondivisa(pesosArgentinos, valordivisa, divisa) {
  ...
  span.innerText =
    ...
    " " +
    divisa;
  span.style.fontFamily = "'Pacifico', sans-serif";
...
botonConvertir.style.fontFamily = "'Pacifico', sans-serif";
